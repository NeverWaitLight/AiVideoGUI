...
Item {
    ...
    function loadTaskDetail() {
        ...
        try {
            requestParamsText.text = JSON.stringify(JSON.parse(params), null, 2)
        } catch (e) {
        ...
        try {
            responseDataText.text = JSON.stringify(JSON.parse(responseData), null, 2)
        } catch (e) {
                        ...
                        Repeater {
                            ...
                            Control {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: root.openTask(model.id)
                                }
                            }
                        }
                    }
